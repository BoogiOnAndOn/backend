...
class MemberRepositoryTest {
    ...
    void testFindAllByWorkerManagedAdminWithNameSearchForRegularTest() {
        ...
        Page<Member> memberList = memberRepository.findAllByWorkerManagedAdminWithNameSearchForRegular(adminId,
                tabCondition, nameSearch, pageable);
    ...
    void testFindAllByWorkerManagedAdminWithNameSearchForSuperTest() {
        ...
        Page<Member> memberList = memberRepository.findAllByWorkerManagedAdminWithNameSearchForSuper(adminId,
                tabCondition, nameSearch, pageable);
        log.info("memberList : " + memberList);
    ...
    void testFindByIdWithManager() {
        ...
        if (findData.length > 0 && findData[0] instanceof Object[]) {
            ...
            for (int i = 0; i < innerArray.length; i++) {
                log.info("innerArray[" + i + "] type: " + (innerArray[i] != null ? innerArray[i].getClass().getName()
                        : "null"));
            }
