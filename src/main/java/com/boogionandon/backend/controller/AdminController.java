...
public class AdminController {
    ...
    public BasicStatisticsResponseDTO basicStatistics(
        ...
        BasicStatisticsResponseDTO findBasicStatistics = cleanService.getBasicStatistics(tapCondition, year, month,
                beachName);
    ...
    public PageResponseDTO<?> getNewTaskList(String tabCondition, String beachSearch, PageRequestDTO pageRequestDTO,
        ...
        if (tabCondition.equals("조사 완료")) {
            ...
            Page<ResearchMain> findList = researchLocalServiceImpl.findResearchByStatusNeededAndSearch(beachSearch,
                    pageable, adminId);
    ...
    public PageResponseDTO<?> getCompletedTaskList(String tabCondition, String beachSearch,
            PageRequestDTO pageRequestDTO, @PathVariable("adminId") Long adminId) {
        ...
        if (tabCondition.equals("조사")) {
            ...
            Page<ResearchMain> findList = researchLocalServiceImpl.findResearchByStatusCompletedAndSearch(beachSearch,
                    pageable, adminId);
    ...
    public PageResponseDTO<?> getMemberInquiryList(
        ...
        Admin admin = adminRepository.findByIdNotDeleted(adminId)
    ...
    public Map<String, String> createWorker(@PathVariable("adminId") Long adminId,
            @RequestBody CreateWorkerRequestDTO createWorkerRequestDTO) {
    ...
    public Map<String, String> createWorkerBulk(
        ...
        if (filename == null || !(filename.toLowerCase().endsWith(".xlsx") || filename.toLowerCase()
                .endsWith(".xls"))) {
    ...
    public Map<String, String> createAdmin(@PathVariable("adminId") Long adminId,
    ...
    public Map<String, String> deleteMembers(@RequestBody BulkDeleteRequestDTO requestDTO) {
        // 소프트딜리트로 결정
        memberService.softDeleteMembers(requestDTO);
        return Map.of("result", "success");
    }
    
    // ------------ 멤버 삭제 관련 끝 ----------------
    // ------------ Worker endDate 수정 관련 시작 ----------------
    @PatchMapping("/member-inquiry/worker/update/{workerId}")
    public Map<String, String> updateWorkerEndDate(@PathVariable("workerId") Long workerId,
            @RequestBody WorkerUpdateEndDateRequestDTO requestDTO) {
        try {
            memberService.updateWorkerEndDate(workerId, requestDTO);
        } catch (CustomException e) {
            return Map.of("error", e.getMessage());
        }
        return Map.of("result", "success");
    }
    // ------------ Worker endDate 수정 관련 끝 ----------------
